...
namespace UltraStrore.Services
{
    public class EmailServices : IEmailServices
    {
        ...
        public async Task SendOtpEmailAccountAsync(string email, string otp)
        {
            var emailSettings = _configuration.GetSection("EmailSettings");
            var message = new MimeMessage();
            message.From.Add(new MailboxAddress("UltraStore", emailSettings["SenderEmail"]));
            message.To.Add(new MailboxAddress("", email));
            message.Subject = "Mã OTP để kích hoạt tài khoản từ UltraStore";
            ...
            string htmlBody = @"
                ...
                <body>
                    <div class='container'>
                        ...
                        <div class='content'>
                            <p>Chúng tôi nhận được yêu cầu kích hoạt cho tài khoản của bạn.</p>
                            <p>Mã OTP của bạn là:</p>
                            <div class='otp'>" + otp + @"</div>
                            <p>Mã này sẽ hết hạn sau <strong>10 phút</strong>.</p>
